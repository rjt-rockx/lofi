...
export enum SettingsActionType {
  ...
  SetDisplayVolumeChange = 'setDisplayVolumeChange',
  SetTokens = 'setTokens',
...
export type SettingsAction =
  ...
  | {
      type: SettingsActionType.SetDisplayVolumeChange;
      payload: boolean;
    }
  | {
...
export const useSettingsReducer = (state: Settings, action: SettingsAction): Settings => {
  switch (action.type) {
    ...
    case SettingsActionType.SetDisplayVolumeChange: {
      return {
        ...state,
        isDisplayVolumeChange: action.payload,
      };
    }
